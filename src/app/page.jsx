...
import logoYoungerAssociates from '@/images/logos/youngerassociates.png'
...
function Resume() {
  let resume = [
    ...
    {
      company: 'Younger Associates',
      title: 'Web Developer',
      logo: logoYoungerAssociates,
      start: '2016',
      end: '2021',
    }
  ]
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
        ...
        {resume.map((role, roleIndex) => (
          <li key={roleIndex} className="flex gap-4">
            <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
              <Image src={role.logo} alt="" className="h-7 w-7 rounded-full dark:bg-white" unoptimized />
            </div>
      ...
      <Button href="https://drive.google.com/file/d/1tQtgsyIY9gwYF6t6kwIfdgIKkgV9gRVf/view?usp=drive_link" target="_blank" variant="secondary" className="group mt-6 w-full">
        Download CV
